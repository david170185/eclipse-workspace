...
function know(z) {
	location.href = 'https://search.naver.com/search.naver?where=kin&sm=tab_jum&query=' + z
}
function arr() {
	name =['홍', '김', '송', '정']	
...
<body>
<button onclick="add(100, 200)">더하기기능 처리</button>
<button onclick="minus(300)">빼기기능 처리</button>
...
<button onclick="know('엔트로피')">네이버에서 지식인에서 엔트로피 검색</button>
