				...
				<%} else {%>
					...
					<table>
						<tr>
							...
							<td>
								<a href="UserLogout.jsp">
									<button style="border:none; border-radius:5px; width:200px; height: 50px; background: pink; color: red; font-family: bold; font-size: 20px;">
										로그아웃
									</button>
								</a>
							</td>
