...
public class ThreadGraphic4 extends JFrame {
	   // JFrame의 메서드, 멤버변수 상속받아 사용 가능

	   JLabel day, img, name; //생성자 바깥에서 각 라벨 변수 선언

	   public ThreadGraphic4() {
	      getContentPane().setBackground(Color.GREEN); //new로 객체 생성시 자동 호출되도록 => 생성자
	   ...
	   public static void main(String[] args) { //메인
		   ThreadGraphic4 test = new ThreadGraphic4(); //생성자 호출해줌
	   }
	   ...
	   public class Name extends Thread { // 카운트클래스 이너클래스로 가져옴
	      ...
	      public void run(){
	         //이름을 담을 리스트 생성
	         String[] list1 = { "참교육", "여신강림", "고수", "독립일기", "외모지상주의", "호랑이형님", "싸움독학"};
	   ...
	   public class Img extends Thread { 
	      ...
	      public void run() {
	         //이미지를 담을 리스트 생성
	         String[] list2 = { "참교육.png", "여신강림.png", "고수.png", "독립일기.png", "외모지상주의.png", "호랑이형님.png", "싸움독학.png"};
